...
import com.teddong.billforyou.fillforyou.mvp.presenter.Imp.UserInfoPresenterImp;
...
import com.teddong.billforyou.fillforyou.widget.CommonItemLayout;
    ...
    private void takePicture() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            tempUri = FileProvider.getUriForFile(UserInfoActivity.this,
                    "com.teddong.billforyou.fillforyou.fileProvider", file);
        } else {
